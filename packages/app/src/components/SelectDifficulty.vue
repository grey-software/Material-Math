  ...
  <div class="flex justify-around">
    ...
    >
      <div class="flex justify-center items-center">
        <div
          class="easy-vertical-div"
          :class="{'selected-color': isEasy}"
        />
        <div
    ...
    >
      <div class="flex justify-center items-center">
        <div
          class="medium-vertical-div"
          :class="{'selected-color': isMedium}"
        />
        <div
          class="easy-vertical-div"
          :class="{'selected-color': isMedium}"
    ...
    >
      <div class="flex justify-center items-center">
        <div
          class="hard-vertical-div"
          :class="{'selected-color': isHard}"
        />
        <div
          class="medium-vertical-div"
          :class="{'selected-color': isHard}"
